...
const htmlString = `
    ...
    <h1>General Terms</h1>
    <p>
      By accessing and placing an order with Doctome, you confirm that you are
      ...
      any email or other type of communication between you and Doctome.
    </p>
    <p>
      Under no circumstances shall Doctome team be liable for any direct,
      ...
      inability to use, the materials on this site, even if Doctome team or an
    ...
    <p>
      Doctome will not be responsible for any outcome that may occur during the
    ...
    <h1>License</h1>
    <p>
      Doctome grants you a revocable, non-exclusive, non-transferable, limited
      license to download, install and use the app strictly in accordance with
      the terms of this Agreement.
    </p>
    <p>
      These Terms & Conditions are a contract between you and Doctome (referred
      to in these Terms & Conditions as "Doctome", "us", "we" or "our"), the
      provider of the Doctome website and the services accessible from the
      Doctome website (which are collectively referred to in these Terms &
      Conditions as the "Doctome Service").
    </p>
    <p>
      You are agreeing to be bound by these Terms & Conditions. If you do not
      agree to these Terms & Conditions, please do not use the Doctome Service.
    ...
    <ul>
      ...
      <li>
        ...
        refers to Doctome Healthcare Services Private Limited, Plot no 27, KGM
        Enclave, Bachupally, Hyderabad, Telangana, India - 500090 that is
        responsible for your information under this Terms & Conditions.
      </li>
      <li>
        Country: where Doctome or the owners/founders of Doctome are based, in
        this case is
      </li>
      <li>
        Device: any internet connected device such as a phone, tablet, computer
        or any other device that can be used to visit Doctome and use the
        services.
      </li>
      <li>
        Service: refers to the service provided by Doctome as described in the
      ...
      <li>Website: Doctome's site, which can be accessed via this URL:</li>
      <li>
        You: a person or entity that is registered with Doctome to use the
        Services.
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>
        ...
        copyright or trademark) of Doctome or its affiliates, partners,
        suppliers or the licensors of the app.
      </li>
    </ul>
    <h1>Return and Refund Policy</h1>
    <p>
      Thanks for shopping at Doctome. We appreciate the fact that you like to
    ...
    <p>
      ...
      to transactions at Doctome. We’ll be as brief as our attorneys will allow.
      The main thing to remember is that by placing an order or making a
      purchase at Doctome, you agree to the terms along with Doctome's Privacy
      Policy.
    </p>
    <p>
    ...
    <p>
      ...
      "Suggestions") provided by you to Doctome with respect to the app shall
      remain the sole and exclusive property of Doctome.
    </p>
    <p>
      Doctome shall be free to use, copy, modify, publish, or redistribute the
    ...
    <p>
      ...
      contain links to other websites not operated or controlled by Doctome. We
    ...
    <h1>Cookies</h1>
    <p>
      Doctome uses "Cookies" to identify the areas of our website that you have
    ...
    <p>
      You acknowledge and agree that Doctome may stop (permanently or
      ...
      specifically inform Doctome when you stop using the Service. You
      acknowledge and agree that if Doctome disables access to your account, you
    ...
    <p>
      Doctome reserves the right to modify, suspend or discontinue, temporarily
    ...
    <p>
      Doctome may from time to time provide enhancements or improvements to the
    ...
    <p>
      ...
      the app. You agree that Doctome has no obligation to (i) provide any
    ...
    <p>
      You acknowledge and agree that Doctome shall not be responsible for any
      ...
      aspect thereof. Doctome does not assume and shall not have any liability
    ...
    <p>
      This Agreement shall remain in effect until terminated by you or Doctome.
    </p>
    <p>
      Doctome may, in its sole discretion, at any time and for any or no reason,
    ...
    <p>
      ...
      Doctome, in the event that you fail to comply with any provision of this
    ...
    <p>
      Termination of this Agreement will not limit any of Doctome's rights or
    ...
    <p>
      You agree to indemnify and hold Doctome and its parents, subsidiaries,
    ...
    <p>
      ...
      under applicable law, Doctome, on its own behalf and on behalf of its
      ...
      foregoing, Doctome provides no warranty or undertaking, and makes no
    ...
    <p>
      Without limiting the foregoing, neither Doctome nor any Doctome's provider
      makes any representation or warranty of any kind, express or implied: (i)
      as to the operation or availability of the app, or the information,
      ...
      from or on behalf of Doctome are free of viruses, scripts, trojan horses,
    ...
    <p>
      ...
      Doctome and any of its suppliers under any provision of this Agreement and
    ...
    <p>
      ...
      Doctome or its suppliers be liable for any special, incidental, indirect,
      ...
      Doctome or any supplier has been advised of the possibility of such
    ...
    <p>
      ...
      notices published by Doctome on the Services, shall constitute the entire
      agreement between you and Doctome concerning the Services. If any
      ...
      Doctome's failure to assert any right or provision under this Agreement
      shall not constitute a waiver of such right or provision. YOU AND Doctome
    ...
    <p>
      Doctome reserves the right, at its sole discretion, to modify or replace
    ...
    <p>
      ...
      to the new terms, you are no longer authorized to use Doctome.
    </p>

    <h1>Entire Agreement</h1>
    <p>
      The Agreement constitutes the entire agreement between you and Doctome
      regarding your use of the app and supersedes all prior and contemporaneous
      written or oral agreements between you and Doctome.
    </p>
    <p>
      You may be subject to additional terms and conditions that apply when you
      use or purchase other Doctome's services, which Doctome will provide to
    ...
    <p>
      ...
      by Doctome, its licensors or other providers of such material and are
      ...
      Doctome, unless and except as is expressly provided in these Terms &
    ...
    <p>
      ...
      ENFORCEMENT OR VALIDITY OF YOUR OR Doctome's INTELLECTUAL PROPERTY RIGHTS.
      The term “dispute” means any dispute, action, or other controversy between
      you and Doctome concerning the Services or this agreement, whether in
    ...
    <p>
      In the event of a dispute, you or Doctome must give the other a Notice of
      ...
      via email to: <a
        ...
        class="__cf_email__"
        data-cfemail="3b484e4b4b54494f7b5f54584f54565e155255"
        >[email&#160;protected]</a
      >. Doctome will send any Notice of Dispute to you by mail to your address
      if we have it, or otherwise to your email address. You and Doctome will
      ...
      days, you or Doctome may commence arbitration.
    </p>

    <h1>Binding Arbitration</h1>
    <p>
      If you and Doctome don’t resolve any dispute by informal negotiation, any
    ...
    <p>
      ...
      become the sole property of Doctome without any compensation or credit to
      you whatsoever. Doctome and its affiliates shall have no obligations with
    ...
    <h1>Promotions</h1>
    <p>
      Doctome may, from time to time, include contests, promotions, sweepstakes,
    ...
    <p>
      ...
      if in writing and signed by an authorized representative of Doctome.
      Doctome will be entitled to injunctive or other equitable relief (without
      the obligations of posting any bond or surety) in the event of any breach
      or anticipatory breach by you. Doctome operates and controls the Doctome
      Service from its offices in . The Service is not intended for distribution
      to or use by any person or entity in any jurisdiction or country where
      such distribution or use would be contrary to law or regulation.
      Accordingly, those persons who choose to access the Doctome Service from
      ...
      Doctome Privacy Policy) contains the entire understanding, and supersedes
      all prior understandings, between you and Doctome concerning its subject
      matter, and cannot be changed or modified by you. The section headings
      used in this Agreement are for convenience only and will not be given any
      legal import.
    </p>

    <h1>Disclaimer</h1>
    <p>
      Doctome is not responsible for any content, code or any other imprecision.
    </p>
    <p>Doctome does not provide warranties or guarantees.</p>
    <p>
      In no event shall Doctome be liable for any special, direct, indirect,
    ...
    <p>
      The Doctome Service and its contents are provided "as is" and "as
      available" without any warranty or representations of any kind, whether
      express or implied. Doctome is a distributor and not a publisher of the
      content supplied by third parties; as such, Doctome exercises no editorial
      ...
      or merchandise provided through or accessible via the Doctome Service.
      Without limiting the foregoing, Doctome specifically disclaims all
      warranties and representations in any content transmitted on or in
      connection with the Doctome Service or on sites that may appear as links
      on the Doctome Service, or in the products provided as a part of, or
      otherwise in connection with, the Doctome Service, including without
      limitation any warranties of merchantability, fitness for a particular
      purpose or non-infringement of third party rights. No oral advice or
      written information given by Doctome or any of its affiliates, employees,
      ...
      limiting the foregoing, Doctome does not warrant that the Doctome Service
    ...
    <ul>
      <li>Via Email: support@doctome.in</li>
    </ul>
  `
