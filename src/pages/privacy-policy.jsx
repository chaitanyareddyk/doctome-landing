...
const htmlString = ` <h1>Privacy Policy</h1>
...
<p>To help explain things as clearly as possible in this Privacy Policy, every time any of these terms are referenced, are strictly defined as:
 <ul>
   ...
   <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Doctome Healthcare Services Private Limited, Plot no 27, KGM Enclave, Bachupally, Hyderabad, Telangana, India - 500090 that is responsible for your information under this Privacy Policy.</li>
   <li>Country: where Doctome or the owners/founders of Doctome are based, in this case is India</li>
   <li>Customer: refers to the company, organization or person that signs up to use the Doctome Service to manage the relationships with your consumers or service users.</li>
   <li>Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit Doctome and use the services.</li>
   ...
   <li>Personnel: refers to those individuals who are employed by Doctome or are under contract to perform a service on behalf of one of the parties.</li>
   ...
   <li>Service: refers to the service provided by Doctome as described in the relative terms (if available) and on this platform.</li>
   ...
   <li>You: a person or entity that is registered with Doctome to use the Services.</li>
 </ul>
</p>
...
<ul><li>Name / Username</li><li>Phone Numbers</li><li>Email Addresses</li><li>Mailing Addresses</li><li>Billing Addresses</li><li>Debit/credit card numbers</li><li>Age</li>
  </ul>
  <p>We also collect information from mobile devices for a better user experience, although these features are completely optional:</p><ul><li>Location (GPS): Location data helps to create an accurate representation of your interests, and this can be used to bring more targeted and relevant ads to potential customers.</li><li>Photo Gallery (Pictures): Granting photo gallery access allows the user to upload any picture from their photo gallery, you can safely deny photo gallery access for this app.</li>
  </ul>
...
<h1>When does Doctome use end user information from third parties?</h1>
...
<h1>When does Doctome use customer information from third parties?</h1>
...
<p>Doctome will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>
...
<p>We implement a variety of security measures to maintain the safety of your personal information when you place an order or enter, submit, or access your personal information. We offer the use of a secure server. All supplied sensitive/credit information is transmitted via Secure Socket Layer (SSL) technology and then encrypted into our Payment gateway providers database only to be accessible by those authorized with special access rights to such systems, and are required to keep the information confidential. After a transaction, your private information (credit cards, social security numbers, financials, etc.) is never kept on file. We cannot, however, ensure or warrant the absolute security of any information you transmit to Doctome or guarantee that your information on the Service may not be accessed, disclosed, altered, or destroyed by a breach of any of our physical, technical, or managerial safeguards.</p>
...
<h1>Is the information collected through the Doctome Service secure?</h1>
...
<ul><li>Via Email:  support@doctome.in</li>
</ul>`
